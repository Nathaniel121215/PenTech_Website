...
const Services = ({mode}) => {
    ...
    return (
        <div name='services' className={!mode ? 'z-20 py-[3rem] sm:py-[4rem] md:py-[5rem] lg:py-[6rem] flex justify-center items-center bg-[#402158]' : 'z-20 py-[3rem] sm:py-[4rem] md:py-[5rem] lg:py-[6rem] flex justify-center items-center bg-[#1D2226]'}>
        <div className="max-w-[1581px] w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 px-5 gap-[2rem] 2xl:gap-[6rem] mt-[4rem]">
                ...
                <div className="text-white bg-[#7D5683] rounded-lg p-[2rem] pb-[4rem] pt-[4rem] drop-shadow-2xl">
                    ...
                    <div className="sm:text-[15px] md:text-[16.5px] lg:text-[18px] mt-4">
                        Our custom software solutions are tailored 
                        to the unique needs of our clients. We work 
                        closely with businesses to create innovative 
                        and efficient software that streamlines 
                ...
                <div className="bg-[#C9BFB5] rounded-lg p-[2rem] pb-[4rem] pt-[4rem] drop-shadow-2xl">
                    <div className="w-[7rem] h-[7rem] bg-[#D9D9D9] rounded-lg">
                ...
                <div className="bg-[#E2E9FF] rounded-lg p-[2rem] pb-[4rem] pt-[4rem] drop-shadow-2xl">
                    <div className="w-[7rem] h-[7rem] bg-[#D9D9D9] rounded-lg">
